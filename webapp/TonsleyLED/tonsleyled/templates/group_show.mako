                ...
                <div class="panel-heading">
                    ...
                    % if group_admin:
                        <div class="pull-right">
                            <span class='alert small' style='display: none' id='update-msg' role='alert'></span>
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tr>
                            <%
                                ...
                                if group_admin:
                                    cols += ['Enabled' ,'Position', 'Message?', 'Delete']
                        ...
                        <tbody id="plugins">
                            % for plugin in schedule:
                                <tr data-plugin-id="${plugin.led_plugin_id}">
                                    ...
                                    <td>
                                        <a href="/users/${plugin.led_plugin.user_id}">${plugin.led_plugin.user.email}</a>
                                    </td>
                                    % if group_admin:
                                        <td><input class="form-control" type="number" style="width:95px"
                                                   value="${plugin.duration}" type="number" min="0"/></td>
                                        <td><input type="checkbox" ${checked(plugin.enabled)}/></td>
                                        <td><i class="fa fa-arrow-up row-up"></i> <i
                                                class="fa fa-arrow-down row-down"></i>
                                        </td>
                                        <td class="message">
                                            ## message?
                        ...
                        <tbody>
                            ...
                            % for user in users:
                                <tr>
                                    ...
                                    <td>
                                        <select data-user-id="${user.led_user_id}" class="user_level show-tick"
                                                data-width="fit">
                                            <option value="0"
